...
```html
<sp-textfield placeholder="Enter your name" valid multiline>
    <textarea></textarea>
</sp-textfield>
```
...
```html
<sp-textfield placeholder="Enter your name" invalid multiline>
    <textarea></textarea>
</sp-textfield>
```
...
```html
<sp-textfield placeholder="Enter your name" quiet multiline>
    <textarea></textarea>
</sp-textfield>
```
