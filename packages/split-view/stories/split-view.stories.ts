...
export const HorizontalResizableCollapsibleStart = (): TemplateResult => {
    return html`
        <sp-split-view
            resizable
            collapsible
...
export const HorizontalResizableCollapsibleStartEnd = (): TemplateResult => {
    return html`
        <sp-split-view
            resizable
            collapsible
...
export const VerticalResizableCollapsibleStart = (): TemplateResult => {
    return html`
        <sp-split-view
            vertical
            resizable
...
export const VerticalResizableCollapsibleStartEnd = (): TemplateResult => {
    return html`
        <sp-split-view
            vertical
            resizable
