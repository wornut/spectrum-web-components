...
When looking to leverage the `AcitionMenu` base class as a type and/or for extension purposes, do so via:

```
import { AcitionMenu } from '@spectrum-web-components/action-menu';
```
